...
public class Element {
    ...
    public Element(String nombre, String simbolo, int numeroAtomico, String bloque, String grupo, String periodo, String masaAtomica, String rutaImagen,String descripcion) {
        this.nombre = nombre;
